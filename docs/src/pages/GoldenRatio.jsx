...
const typeScale = [-2, -1, 0, 1, 2, 3, 4, 5].map((n) => ({
	...
	label: [null, null, "Body", "Lead / H5", "H3", "H1", "Display", "Hero"][
		n + 2
	],
}));
	...
	return (
		<Page>
			...
			<Section title="What is φ?" id="what-is-phi">
				...
				<Prose>
					<p>
						The key insight: <strong>divide any value by φ (÷ 1.618)</strong> to
						get the minor portion.
						<strong>Multiply by φ (× 1.618)</strong> to get the next step up.
						Chaining these steps creates a natural, harmonious scale used in
						everything from the Parthenon to Apple product design.
					</p>
				</Prose>
...
font-size: golden-step(3);    // → 4.236rem`}
			...
			<Section title="Golden Typography Scale" id="typography">
				<Prose>
					<p>
						Every step is the previous × φ. This produces the most visually
						harmonious type hierarchy possible — the same proportions used in
...
.gs-leading-compact { line-height: 1.0;   }`}
				...
				<Callout type="tip">
					<strong>Pro tip:</strong> Use <code>φ (1.618)</code> itself as your
					body line-height — it is the natural reading rhythm. Use{" "}
					<code>√φ ≈ 1.272</code> for tight headings.
				</Callout>
			</Section>
			...
			<Section title="Golden Spacing Scale" id="spacing">
				<Prose>
					<p>
						Nine spacing steps anchored at 1rem, scaling by φ in both
						directions. Available as CSS custom properties (
						<code>--gs-space-1</code>…<code>--gs-space-9</code>) and utility
						classes.
					</p>
				</Prose>
...
.hero {
  ...
  // → 2.618rem top/bottom, 1.618rem left/right
			...
			<Section title="Golden Ratio Grid" id="grid">
				<Prose>
					<p>
						The classic golden ratio layout: a major column at{" "}
						<strong>61.8%</strong> and minor at <strong>38.2%</strong>. Used by
						countless great publications, landing pages, and editorial designs.
					</p>
				</Prose>
