...
import { Page, PageHeader, Section, Prose, Badge } from '../components/Page'
import CodeBlock from '../components/CodeBlock'
import styles from './Home.module.css'

const features = [
  { icon: '✦', label: 'Golden Ratio', desc: 'φ-derived typography, spacing, grid, and aspect ratios', to: '/golden-ratio', badge: 'new' },
  { icon: '⬛', label: 'Design Tokens', desc: 'All variables as CSS custom properties — works with Tailwind v4', to: '/tokens', badge: 'utility' },
  { icon: '◈', label: 'Fluid Typography', desc: 'clamp()-based font scaling with zero media queries', to: '/typography', badge: 'utility' },
  { icon: '▦', label: 'CSS Grid', desc: '12-column grid with responsive breakpoint variants', to: '/grid', badge: 'utility' },
  { icon: '◐', label: 'Dark Mode', desc: '[data-theme="dark"] + prefers-color-scheme auto toggling', to: '/dark-mode', badge: 'utility' },
  { icon: '◻', label: 'Container Queries', desc: 'Component-level breakpoints with @container', to: '/container-queries', badge: 'new' },
  { icon: '▷', label: 'Animations', desc: '12 keyframe animations with reduced-motion guard', to: '/animations', badge: 'utility' },
  { icon: '⚡', label: 'Tailwind Plugin', desc: 'Inject all tokens and utilities into Tailwind v3/v4', to: '/tailwind-plugin', badge: 'new' },
]
    ...
    <Page>
      <div className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          Fill the Gaps.<br />Design with Precision.
        </h1>
        <p className={styles.heroDesc}>
          A SCSS utility toolkit that bridges what Tailwind can't.
          Design tokens, fluid typography, container queries, dark mode,
          golden ratio proportions — all in one composable system.
        </p>
