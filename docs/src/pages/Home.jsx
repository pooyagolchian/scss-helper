    ...
    <Page>
      <div className={styles.hero}>
        ...
        <p className={styles.heroDesc}>
          A SCSS utility toolkit that bridges what Tailwind can't. Design tokens, fluid typography,
          container queries, dark mode, golden ratio proportions — all in one composable system.
        </p>
