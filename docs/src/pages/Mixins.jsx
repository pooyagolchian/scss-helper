          ...
          rows={[
            {
              ...
              type: 'SCSS function',
              default: '$base: 1rem',
              description: 'Returns φⁿ rem. Positive steps grow, negative shrink.',
            },
            {
              name: 'golden-ratio-split($width)',
              type: 'SCSS function',
              default: '',
              description: 'Returns 61.8% of $width (major golden portion).',
            },
            {
              name: 'golden-ratio-minor($width)',
              type: 'SCSS function',
              default: '',
              description: 'Returns 38.2% of $width (minor golden portion).',
            },
            {
              name: 'fluid-type($min, $max, ...)',
              type: 'SCSS function',
              default: '$min-vw: 320px, $max-vw: 1440px',
              description: 'Returns a clamp() value for fluid typography.',
            },
          ]}
        />
      </Section>
