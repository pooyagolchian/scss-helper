  ...
  return (
    <Page>
      ...
      <Section title="Animation classes" id="animations">
        <Prose>
          <p>
            Add <code>.animate-{'{name}'}</code> to any element. Click a card to preview.
          </p>
        </Prose>
...
:root {
  ...
  --easing: cubic-bezier(0.4, 0, 0.2, 1);
      ...
      <Section title="Reduced motion" id="a11y">
        <Callout type="tip">
          Every <code>.animate-*</code> and <code>.transition-*</code> class is automatically
          disabled for users who have <strong>prefers-reduced-motion: reduce</strong> set in their
          OS settings. No extra work required.
        </Callout>
