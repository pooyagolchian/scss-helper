...
import { Callout, Page, PageHeader, PropTable, Prose, Section } from '../components/Page'
...
module.exports = {
  ...
  // 3. theme.extend → Extend Tailwind's own theme
          ...
          rows={[
            {
              ...
              type: 'Layer: base',
              default: '',
              description: 'All --color-*, --spacing-*, --font-size-* custom properties',
            },
            {
              name: '.text-fluid-*',
            ...
            },
            {
              ...
              type: 'theme.extend',
              default: '',
              description: 'All scss-helper colors available as Tailwind color names',
            },
            {
              name: 'theme.fontSize.*',
              type: 'theme.extend',
      ...
      <Section title="Using tokens in Tailwind classes" id="tokens">
        <Prose>
          <p>
            Since the plugin extends Tailwind's color palette, you can reference scss-helper colors
            with Tailwind's standard syntax:
          </p>
        </Prose>
  ...
  plugins: [
    scssHelper({
      ...
      <Section title="Tailwind v4" id="v4">
        <Prose>
          <p>
            Tailwind v4 uses a different plugin API based on CSS <code>@plugin</code> syntax. A
            v4-compatible adapter is planned for the next major release of scss-helper. For now, use
            the SCSS source files directly with v4's <code>@source</code> setup.
          </p>
        </Prose>
